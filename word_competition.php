...
<button type="button" class="btn btn-primary btn-block"
        style="width: 326px; margin-left: 10px; padding-top: 10px; padding-bottom: 10px; background-color: #5bc0de; border-color: #5bc0de; font-size: 30px">Word Competition</button>
